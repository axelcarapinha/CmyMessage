/*
 * Purpose: Establishes a central generalization
 * of the socket's and client's structs, 
 * while providing abstractions for repetitive operations
 * regarding memory allocations or socket configurations
 */
...
typedef struct
{
    ...
    // hash_table *p_usernames_ht; //! Uncomment in case it is a server
    //
